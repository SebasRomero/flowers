...
export function htmlMessage(infoForm: IInfoForm) {
  return `
<!doctype html>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left" class="x" style="font-size:0;padding-bottom:22px;word-break:break-word;">
                                                    <div style="text-align:left;">
                                                        <p style="Margin:0;text-align:left;mso-line-height-alt:24px;mso-ansi-font-size:16px;">
                                                            <span style="font-size:16px;font-family:'Inter','Arial',sans-serif;font-weight:600;color:#000000;line-height:150%;mso-line-height-alt:24px;mso-ansi-font-size:16px;">${infoForm.tourName}</span>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
...
export function plainMessage(infoForm: IInfoForm) {
  return `
    Hi, ${infoForm.name}!
